<html>
	...
	<body>
		...
		<div id="content-row1a">
			<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer1']; ?>.png" height="150">
			</div>
			...
			<div id="BeerInfo">
				<?php echo $abv['Beer1']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer1']; ?>_hops.png" width="200">
			</div>
			<div id="BeerStatus">
		...
		<div id="content-row2">
			...
			<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer2']; ?>.png" height="150">
			</div>
			...
			<div id="BeerInfo">
				<?php echo $abv['Beer2']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer2']; ?>_hops.png" width="200">
			</div>
				<div id="BeerStatus">
		...
		<div id="content-rowe">
			<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer3']; ?>.png" height="150">
			</div>
			...
			<div id="BeerInfo">
				<?php echo $abv['Beer3']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer3']; ?>_hops.png" width="200">
			</div>
			<div id="BeerStatus">
		...
		<div id="content-row2">
			...
			<div id="content-row2a">
				<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer4']; ?>.png" height="150">
			</div>
			<div id="<?php echo $beernamel['Beer4']; ?>">
				...
				<?php echo $abv['Beer4']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer4']; ?>_hops.png" width="200">
			</div>
				<div id="BeerStatus">
		...
		<div id="content-rowe">
			<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer5']; ?>.png" height="150">
			</div>
			...
			<div id="BeerInfo">
				<?php echo $abv['Beer5']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer5']; ?>_hops.png" width="200">
			</div>
			<div id="BeerStatus">
		...
		<div id="content-row2">
			...
			<div id="content-row2a">
				<div id="BeerPic">
				<img src="/images/srm_<?php echo $srm['Beer6']; ?>.png" height="150">
			</div>
			<div id="<?php echo $beernamel['Beer6']; ?>">
				...
				<?php echo $abv['Beer6']; ?>
				<br /><h2>ABV</h2>
				<img src="/images/<?php echo $hops['Beer6']; ?>_hops.png" width="200">
			</div>
				<div id="BeerStatus">
